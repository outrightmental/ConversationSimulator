...
description: "Step-by-step Creator Workbench tutorial for building, validating, testing, and sharing your first scenario pack."
sidebar:
  order: 1
---
...
repository — see [`docs/official-pack-quality-bar.md`](/create/quality-bar/).
...
> editing. The [`README.md`](/create/sample-pack/) inside explains every file.
...
[`docs/pack-validation.md`](/create/pack-validation/) for the full error reference.
...
See [`docs/pack-validation.md`](/create/pack-validation/) for the full static
