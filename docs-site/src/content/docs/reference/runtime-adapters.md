...
description: "How the ChatRuntime abstraction works, the built-in llama.cpp, Ollama, and Fake adapters, and how to add a new runtime."
sidebar:
  order: 3
---
...
For the system overview see [architecture.md](/reference/architecture/).
