---
title: "Steam beta verification report"
description: "Signed-off aggregate report template covering Steam beta client verification across Windows, macOS, Linux, and Steam Deck before the Stage 3 gate."
sidebar:
  order: 36
---
...
- [`docs/release-checklist.md`](/dev/release-checklist/) — Parts E (Windows),
  G (macOS), H (Linux/SteamOS), I (Steam Deck), and J (sign-off) contain the
  step-by-step platform checklists this report summarises
- [`docs/QA_STEAM_PLATFORM_MATRIX.md`](/dev/qa-steam-platform-matrix/) — full QA
  test case matrix (TC-01 through TC-11) and per-platform hardware tiers
- [`docs/steam-mvp-scope.md`](/dev/steam-mvp-scope/) — gate definitions G3-06 and
  G4-02
...
- [`docs/linux-steamos-requirements.md`](/play/linux-steamos/) —
  glibc requirements, SteamOS hardware profile, and performance targets
- [`docs/platform-notes.md`](/play/platform-notes/) — macOS signing, Gatekeeper,
