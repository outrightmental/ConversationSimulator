---
title: "Beta testing"
description: "How to join the Conversation Simulator beta, report problems with the one-click diagnostics flow, and write bug reports that get fixed quickly."
sidebar:
  order: 3
---
