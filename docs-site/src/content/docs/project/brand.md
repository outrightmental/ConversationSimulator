---
title: "Brand guide"
description: "Positioning, boilerplate copy, and tone guidance for writing about Conversation Simulator."
sidebar:
  order: 7
---
...
emerald above (the character, replying). Source:
[`docs/assets/brand/mark.svg`](https://github.com/outrightmental/ConversationSimulator/blob/main/docs/assets/brand/mark.svg).
It is the favicon of the app, the website, and this docs site. Don't recolor
...
brand. Use the CSS custom properties in
[`apps/web/src/index.css`](https://github.com/outrightmental/ConversationSimulator/blob/main/apps/web/src/index.css).
